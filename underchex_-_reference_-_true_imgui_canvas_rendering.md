...
True immediate mode GUI pattern for canvas: runs every frame, combines drawing with input handling. Option 2c. **Not chosen for proto-01** - see [153](/docs/153) for chosen approach.
...
- Or simpler functional rendering from [153](/docs/153)
