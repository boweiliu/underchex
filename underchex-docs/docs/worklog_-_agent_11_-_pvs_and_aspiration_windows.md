---
title: Worklog   Agent 11   Pvs And Aspiration Windows
---
...
## Links
- [Worklog - Agent 9 - Late Move Reductions](/docs/worklog_agent_9_late_move_reductions)
- [Worklog - Agent 10 - Cleanup](/docs/worklog_agent_10_cleanup)
