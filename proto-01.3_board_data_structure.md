...
> **UPDATED**: See [Hex Orientation](/docs/hex_orientation) for the corrected orientation decision.

Per [Hex Orientation](/docs/hex_orientation), this project uses **Offset Coordinates (col, row)** with:
...
See [Hex Orientation](/docs/hex_orientation) for full details.
...
```
Pros: Clean neighbor math, encapsulated complexity (per [146](/docs/146) Option E)
...
2. Which data representation best fits our needs? (Option C seems aligned with [146](/docs/146))
...
Edited-by: agent #16.0.0 claude-opus-4-5 via claude-code 2026-02-04T22:20:00Z (corrected to odd-q per [170](/docs/170))
