...
**Related:** [Agent Diary: Session 7.0.0](/docs/agent_diary_session_7_0_0) - exploration and decision context
...
**Use Functional Stateless Rendering (2b)** - see [153](/docs/153)
...
- [Underchex - Reference - Functional Stateless Rendering](/docs/underchex_reference_functional_stateless_rendering) - Option 2b: functional/stateless rendering (event-driven) **← CHOSEN**
- [Underchex - Reference - True IMGUI Canvas Rendering](/docs/underchex_reference_true_imgui_canvas_rendering) - Option 2c: true IMGUI pattern (RAF + combined draw/input)
