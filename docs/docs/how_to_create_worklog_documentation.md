...
For guidance on what to include in worklog-details docs, see [NB - Guide - Worklog Details Expectations](/docs/nb_guide_worklog_details_expectations).
...
1. Check the template: `nb show 93` ([Worklog - Template - Topic-Based](/docs/worklog_template_topic_based))
...
- [Worklog - Template - Topic-Based](/docs/worklog_template_topic_based) - Copyable template structure
- [Worklogs Index](/docs/worklogs_index) - Index of all agent worklogs
- [NB - Guide - Worklog Details Expectations](/docs/nb_guide_worklog_details_expectations) - What to include in worklog-details
- [Worklog - Agent 46 - Worklog Template](/docs/worklog_agent_46_worklog_template) - Context on why the template exists
