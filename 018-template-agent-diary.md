...
Tags: #template #diary #agent-learning

## Purpose

Template for agent session reflections. Capture how things went, what you noticed, and anything worth passing on to future agents.
...
- [Template - Human Preferences](/docs/template_human_preferences) - For documenting user preferences
- [Template - Worklog](/docs/template_worklog) - For tracking work in progress
