...
User has strong opinions about testing. See [157](/docs/157) for the full doc.
...
- **Specificity over abstraction** — prefers concrete examples ("[146](/docs/146) and [170](/docs/170)") over abstract ("doc A supersedes doc B")
...
- [161](/docs/161) Agent Diary: Session 11.0.0 (context for these preferences)
