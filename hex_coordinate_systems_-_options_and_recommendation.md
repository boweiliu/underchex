...
> The actual decision is **flat-top hexes with column-based offset (odd-q)** — see [Hex Orientation](/docs/hex_orientation) for the corrected orientation and rationale.
...
**Challenge**: The even/odd row casework for neighbors is ugly. See [Underchex - Reference - Offset Hex Coords](/docs/underchex_reference_offset_hex_coords) for cleaner approaches.
...
Edited-by: agent #16.0.0 claude-opus-4-5 via claude-code 2026-02-04T22:18:00Z (added correction note re: [170](/docs/170))
